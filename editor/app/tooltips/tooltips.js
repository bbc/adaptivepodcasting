...
function initButtonTooltips() {
  ...
  tippy(".openInfoButtonTip", {
    content: "Open the Info box to edit project settings",
    placement: buttonTipPlacement,
    maxWidth: buttonTipWidth,
    theme: buttonTipTheme,
  });
...
function initOtherTooltips() {
  tippy("#addSpace", {
    content: "Add more space to the right",
    placement: "top",
    maxWidth: buttonTipWidth,
    theme: buttonTipTheme,
  });
  
    tippy("#addSpaceVertical", {
    content: "Add more space to the bottom",
    placement: "top",
    maxWidth: buttonTipWidth,
    theme: buttonTipTheme,
  });
  ...
  tippy(".infoBoxTip", {
    content:
      "These tabs let you add tests, change previewer values, edit your podcast's manfest and upload existing zip files",
  });
}
...
export function refreshTestTips() {
  ...
  tippy(".acceptedValuesTip", {
    content:
      "Enter the accepted value. Add multiple accepted values using /, eg 'afternoon/night'",
  });
}
